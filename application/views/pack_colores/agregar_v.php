...
<head>
    ...
    <body class=" sidebar_main_open sidebar_main_swipe">
        ...
        <form action="" class="uk-form-stacked" method="POST"  name="formulario_agregar" id="formulario_agregar">
            <h3 class="heading_b uk-margin-bottom">REGISTRAR PACK COLORES</h3>
                        ...
                        <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                            <div class="uk-width-large-1-1">
                                <div class="uk-form-row">
                                    ...
                                    <input type="text" class="md-input" autocomplete="off" style="text-transform: uppercase;" id="pack_color"   name="pack_color" value="" />
                                </div>
                                <div class="uk-form-row">
        ...
        <script> 
          ...
          $('#formulario_agregar').on("submit", function(e){
            ...
            if (pack_color!=''&&color!=null) {
              ...
              var url = "<?php echo base_url();?>Pack_colores_c/agregar";
              $.ajax({                        
                 type: "POST",                 
                 url: url,                     
                 data: formData,
