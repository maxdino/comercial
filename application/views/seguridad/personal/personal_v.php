									...
									<div class="panel-body">
										...
										<?php if(count($personal)>0){ ?>
											<div class="table-responsive">
												<table class="table table-striped table-hover" class="uk-table " id="tabla_default">
													<thead>
														<tr>
														...
														<tr>
															...
															<td class="center">
																<div class="visible-md visible-lg hidden-sm hidden-xs">
																	<a href="<?php echo base_url().'Personal_c/modificar/'.$value->id_empleado; ?>" class="btn btn-xs btn-blue tooltips" data-placement="top" data-original-title="Modificar"><i class="fa fa-edit"></i></a>
																...
																<div class="visible-xs visible-sm hidden-md hidden-lg">
																	<div class="btn-group">
																		...
																		<ul role="menu" class="dropdown-menu pull-right dropdown-dark">
																			<li>
																				<a role="menuitem" tabindex="-1" href="Modificar(<?php echo $value->nro_documento;?>))">
